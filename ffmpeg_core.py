...
"""
==============================================================================
FFMPEG CORE (El Motor de Renderizado - VERSIÓN SHORTS)
==============================================================================
...
Funciona en conjunto con las resoluciones verticales de config.py.
"""
...
def get_text_filter(text, config_dict, in_name, out_name):
    ...
    y = config_dict.get("texto_y", 1500) # Valor por defecto seguro para Shorts
    color = config_dict.get("color", "white")
    size = config_dict.get("font_size", 55)
...
def concatenate_scenes(scene_files, final_output_path, unique_id):
    """
    Toma una lista de videos ya renderizados (escenas verticales) y los pega en uno solo
