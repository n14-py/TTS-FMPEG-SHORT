...
"""
==============================================================================
MAIN ORCHESTRATOR (El Director de Orquesta - VERSIÓN SHORTS)
==============================================================================
Este archivo recibe el payload JSON estructurado, coordina a los recolectores
de fondos, al motor de voz, y a los diferentes módulos de FFmpeg adaptados a 9:16.
Al final, concatena todas las escenas verticales y limpia el servidor.
"""
...
# Importamos las plantillas de escenas que llamarán al constructor vertical
...
def concatenar_escenas(lista_escenas, output_path, unique_id):
    """Pega múltiples videos verticales .mp4 en uno solo usando 'concat' de FFmpeg."""
    ...
    try:
        logger.info(f"  [Orchestrator] Ensamblando {len(lista_escenas)} escenas verticales...")
...
def process_video_payload(payload):
    ...
    final_output_path = os.path.join(OUTPUT_DIR, f"{article_id}_SHORT.mp4") # Agregado sufijo _SHORT
    ...
    logger.info(f"========== INICIANDO PRODUCCIÓN SHORTS: NOTICIA {article_id} ==========")
    ...
    try:
        for idx, scene in enumerate(scenes):
            ...
            # ==========================================================
            # GUARDAR SI FUE EXITOSO Y CREAR MINIATURA VERTICAL
            # ==========================================================
            if exito and os.path.exists(escena_output):
                ...
                if scene_type == "body" and not miniatura_creada:
                    try:
                        # Extraemos un fotograma en el segundo 2
                        cmd_thumb = [
                            "ffmpeg", "-y",
                            "-ss", "00:00:02", 
                            "-i", escena_output,
                        ...
                        if os.path.exists(thumbnail_output_path):
                            logger.info(f"  [Orchestrator] 📸 Miniatura vertical capturada y guardada exitosamente.")
